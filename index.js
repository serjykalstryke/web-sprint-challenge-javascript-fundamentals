...
//In JavaScript, functions create a scope, meaning variables defined within a function cannot be accessed from outside that function. However, nested functions have access to variables defined in their outer function. This is due to a concept in JavaScript called
// "closure". nestedFunction is able to access the internal variable because nestedFunction is closed over the scope of myFunction, hence creating a closure. This closure allows nestedFunction to retain access to all the variables in its containing function’s scope.
...
function USApop(zooAnimals) {
  /*Your Code Here*/
  return zooAnimals.reduce((acc, animal) => acc + animal.population, 0);
}
